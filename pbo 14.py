...
class CustomWidget(QWidget):
    ...
    def greet(self):
        ...
        if not name and not nim and not hobby:
            ...
            return
        if not name:
            QMessageBox.warning(self, "Input Error", "nama belom woi!")
        elif not nim:
            QMessageBox.warning(self, "Input Error", " NIM nya mana!")
        elif not nim.isdigit():
            QMessageBox.warning(self, "Input Error", "NIM nya angka sayang!")
        elif not hobby:
            QMessageBox.warning(self, "Input Error", " hobinya tambahin!")
